...
**Hello React Front End** is the front end of a simple web app that allows users to get a random greeting from the backend API.
...
<details>
  ...
  <ul>
    <li>The API can be found <a href="https://github.com/Ibizugbe/hello-rails-back-end">here</a></li>
  </ul>
</details>
...
- No live demo, as this is just a test app.
...
```sh
  cd my-folder
  git clone https://github.com/Ibizugbe/hello-rails-back-end
```
...
- [ ] **It wont be any future features, as this is just a test app.**
